...
exports.getAllPayment = async (req, res) => {
    ...
    return res.status(200).json({ success: true, data: data[0], total: groupsCount.count })
}
...
exports.paymetStatistic = async (req, res) => {
    ...
    return res.status(200).json({ success: true, data: { totalAmountThisDay: totalAmountThisDay[0][0], totalAmountThisMonth: totalAmountThisMonth[0][0], totalThisMonth: totalThisMonth[0][0], qarz: qarz[0][0] } })
}
